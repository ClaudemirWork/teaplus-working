// CÓDIGO FINAL E COMPLETO COM LÓGICA DE CLIQUE
'use client';
...
// Sua lista completa de 50 histórias (deve estar aqui)
                  ...
                  <div className="space-y-3">
                      ...
                      {shuffledElements.length === 0 && (
                          <div className="text-center py-16 text-gray-400">
                              <p className="text-lg">Todas as partes foram movidas!</p>
                          </div>
                      )}
                  </div>
              </div>
                  ...
                  <div className="min-h-[250px] border-3 border-dashed border-purple-300 rounded-lg p-4 space-y-3 bg-purple-50/30">
                      ...
                      {userSequence.length === 0 && (
                          <div className="text-center flex items-center justify-center h-full text-gray-400">
                              <p className="text-lg">Clique nas partes para adicioná-las aqui na ordem certa.</p>
                          </div>
                      )}
                  </div>
