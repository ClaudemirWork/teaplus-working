...
const App = () => {
  ...
  // Suas constantes (features, modules, stats, bibliography) continuam aqui...
  const features = [ { icon: <Brain className="text-blue-500 w-8 h-8" />, title: "Baseado em Ciência", description: "Atividades fundamentadas em ABA, TEACCH e Neuropsicologia Cognitiva.", }, { icon: <HeartHandshake className="text-emerald-500 w-8 h-8" />, title: "Integração TEA + TDAH", description: "Primeira plataforma brasileira a trabalhar especificamente com ambos os transtornos.", }, { icon: <Users className="text-orange-500 w-8 h-8" />, title: "Para toda a família", description: "Interface adaptada para crianças, adolescentes, pais e profissionais.", }, ];
  const modules = [ { icon: <CheckCircle className="text-blue-500 w-8 h-8" />, title: "Módulo TEA", subtitle: "Habilidades sociais e comunicação", items: ["Comunicação visual", "Interação social", "Rotinas estruturadas"], bgColor: "bg-blue-50", dotColor: "bg-blue-500" }, { icon: <Sparkles className="text-orange-500 w-8 h-8" />, title: "Módulo TDAH", subtitle: "Funções executivas", items: ["Atenção e foco", "Memória de trabalho", "Controle inibitório"], bgColor: "bg-orange-50", dotColor: "bg-orange-500" }, { icon: <Brain className="text-emerald-500 w-8 h-8" />, title: "Interseção", subtitle: "Atividades integradas", items: ["Regulação emocional", "Autoconhecimento", "Tomada de decisão"], bgColor: "bg-emerald-50", dotColor: "bg-emerald-500" }, ];
  const stats = [ { value: "50-70%", label: "das crianças com TEA também apresentam TDAH", color: "text-blue-500" }, { value: "32+", label: "atividades cientificamente validadas", color: "text-emerald-500" }, { value: "100%", label: "segurança jurídica e conformidade", color: "text-orange-500" }, ];
  const bibliography = [ "Diamond, A. (2013). Executive Functions. Annual Review of Psychology", "ABA Intervention Strategies for Autism Spectrum Disorder", "TEACCH Structured Teaching Approaches", "CDC Guidelines for Autism Spectrum Disorder", "Neuropsychological Assessment for Developmental Disorders", "Social Scripts & Video Modeling Strategies", "DSM-5 Criteria for ADHD and Autism Spectrum", "Journal of Applied Behavior Analysis", ];
  ...
  return (
    <div className="font-sans antialiased bg-slate-50 text-slate-700">
      ...
      <main>
        ...
        <section className="py-20 bg-white"> <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center"> <h2 className="text-4xl font-bold text-slate-900 mb-12">Dados que importam</h2> <div className="grid grid-cols-1 md:grid-cols-3 gap-10"> {stats.map((stat, index) => ( <div key={index} className="p-8"> <div className={`text-5xl font-extrabold mb-2 ${stat.color}`}>{stat.value}</div> <p className="text-lg text-slate-600">{stat.label}</p> </div> ))} </div> </div> </section>
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-24"> <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white"> <h2 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight drop-shadow-sm"> Comece sua jornada hoje </h2> <p className="text-xl mb-10 max-w-2xl mx-auto"> Junte-se às famílias e profissionais que confiam no LudiTEA. </p> <a href="/login" className="bg-white text-blue-600 px-8 py-4 rounded-full font-bold shadow-lg hover:bg-blue-50 transition-transform transform hover:-translate-y-1"> Testar Gratuitamente </a> </div> </section>
      </main>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            {/* O resto do seu rodapé continua igual */}
            <div> <h3 className="font-bold text-white mb-4">Produto</h3> <ul className="text-sm space-y-2"> <li><a href="#" className="hover:text-white transition-colors">Como funciona</a></li> <li><a href="#" className="hover:text-white transition-colors">Recursos</a></li> <li><a href="#" className="hover:text-white transition-colors">Preços</a></li> </ul> </div> <div> <h3 className="font-bold text-white mb-4">Suporte</h3> <ul className="text-sm space-y-2"> <li><a href="#" className="hover:text-white transition-colors">Central de ajuda</a></li> <li><a href="#" className="hover:text-white transition-colors">Contato</a></li> <li><a href="#" className="hover:text-white transition-colors">FAQ</a></li> </ul> </div> <div> <h3 className="font-bold text-white mb-4">Legal</h3> <ul className="text-sm space-y-2"> <li><a href="#" className="hover:text-white transition-colors">Privacidade</a></li> <li><a href="#" className="hover:text-white transition-colors">Termos</a></li> <li><a href="#" className="hover:text-white transition-colors">LGPD</a></li> </ul> </div>
          </div>
