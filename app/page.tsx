...
const App = () => {
  ...
  // ... (O resto das suas constantes features, modules, stats, etc. continua igual)
  ...
  return (
    <div className="font-sans antialiased bg-slate-50 text-slate-700">
      {/* ===== CABEÇALHO 100% CORRIGIDO ===== */}
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <a href="/" className="flex items-center">
            <Image
              src="/images/logo-luditea.png" // 1. NOME DO ARQUIVO CORRIGIDO
              alt="Logo LudiTEA"
              width={180} // Otimização: tamanho original da imagem
              height={55} // Otimização: tamanho original da imagem
              className="h-10 w-auto md:h-12" // 2. CONTROLE DE TAMANHO RESPONSIVO
            />
          </a>
      ...
      <main>
        {/* ... (Todo o resto do seu código da página continua aqui) ... */}
            ...
            <div>
              <a href="/" className="mb-4 inline-block">
                <Image
                  ...
                  width={140}
                  height={43}
                  className="h-9 w-auto" // 2. CONTROLE DE TAMANHO RESPONSIVO
                />
              </a>
              <p className="text-sm">
