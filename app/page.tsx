...
const App = () => {
  ...
  const modules = [
    {
      icon: <CheckCircle className="text-blue-500 w-6 h-6 md:w-8 md:h-8" />,
      title: "Módulo TEA",
    ...
    {
      icon: <Sparkles className="text-orange-500 w-6 h-6 md:w-8 md:h-8" />,
      title: "Módulo TDAH",
    ...
    {
      icon: <Brain className="text-emerald-500 w-6 h-6 md:w-8 md:h-8" />,
      title: "Interseção",
  ...
  return (
    <div className="font-sans antialiased bg-slate-50 text-slate-700">
      {/* ===== HEADER CORRIGIDO - Altura reduzida e logo aumentado ===== */}
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4 flex justify-between items-center gap-4">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center">
              <a 
                ...
                className="bg-blue-600 text-white px-6 sm:px-8 py-3 md:py-4 rounded-full font-bold shadow-lg hover:bg-blue-700 transition-transform transform hover:-translate-y-1 text-sm sm:text-base"
              >
                Leia abaixo para conhecer mais
                <ChevronRight className="inline-block ml-2 w-4 h-4 sm:w-5 sm:h-5" />
              </a>
            </div>
          </div>
        </section>
                  ...
                  <ul className="space-y-2 md:space-y-3 text-sm sm:text-base md:text-lg text-slate-700">
                    {module.items.map((item, i) => (
                      <li key={i} className="flex items-center">
                        <CheckCircle className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-emerald-500 flex-shrink-0" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
