...
export default function HistoriasEpicasGame() {
    ...
    const renderTitleScreen = () => (
        <div className="relative w-full h-screen flex justify-center items-center bg-gradient-to-b from-[#1e0c42] to-[#431d6d] overflow-hidden">
            {/* Efeitos de Estrela com Tailwind */}
            ...
            <div className="relative z-10 flex flex-col items-center text-center text-white animate-fade-in">
                <div className="animate-float">
                    <Image
                        ...
                        width={350}
                        height={350}
                        className="w-[200px] h-auto sm:w-[300px] md:w-[350px] drop-shadow-2xl mb-[-20px]"
                        priority
                    />
                </div>
                <h1 className="font-display text-5xl sm:text-7xl md:text-8xl font-bold text-yellow-400 title-text-shadow tracking-wider">
                    Histórias Épicas
                </h1>
                <p className="text-lg sm:text-xl text-gray-200 mt-4 mb-10 drop-shadow-md">
                    Uma aventura de criação e fantasia
                </p>
        ...
        return (
            <div className="w-full h-screen flex justify-center items-center p-4 bg-gradient-to-br from-blue-200 via-green-200 to-yellow-200">
                <div className="relative z-10 bg-white/90 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-xl w-full max-w-6xl mx-auto border-4 border-violet-300 animate-fade-in">
                    {/* Conteúdo do Jogo (cabeçalho, história, cards...) */}
    ...
    return (
        <>
            ...
            <style jsx global>{`
                ...
                /* Animações e Estilos da Tela de Título */
                ...
                /* Estilo do fundo de estrelas (usando um pseudo-elemento) */
                .stars-bg::before {
                    content: '';
                    position: absolute;
                    top: 0;
                ...
                .title-text-shadow {
                    text-shadow: 0 0 8px rgba(255, 215, 0, 0.7), 0 0 16px rgba(255, 172, 77, 0.5), 0 0 24px rgba(255, 0, 153, 0.5);
                }
                .cta-shadow {
