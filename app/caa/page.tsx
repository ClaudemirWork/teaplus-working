...
export default function CAAActivityPage() {
    ...
    // ✅ FUNÇÃO CORRIGIDA - USANDO usuario_id AO INVÉS DE paciente_id
    const handleSaveSession = async () => {
        ...
        // ✅ CORREÇÃO PRINCIPAL: Mudança de paciente_id para usuario_id
        const { data, error } = await supabase
            .from('sessoes')
            .insert([{
                usuario_id: user.id,  // ✅ CORRIGIDO: era paciente_id
                atividade_nome: 'CAA',  // Mantido conforme estava
                pontuacao_final: totalAtosComunicativos,  // Mantido conforme estava
                data_fim: fimSessao.toISOString()  // Mantido conforme estava
            }]);
